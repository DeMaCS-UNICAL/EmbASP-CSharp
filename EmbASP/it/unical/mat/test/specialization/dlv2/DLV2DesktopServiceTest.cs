...
namespace it.unical.mat.test
{
    ...
    public class DLV2DesktopServiceTest
    {
        ...
        public string GetPath()
        {
            ...
            path.Append(".." + System.IO.Path.DirectorySeparatorChar + ".." + System.IO.Path.DirectorySeparatorChar + ".." + System.IO.Path.DirectorySeparatorChar + ".." + System.IO.Path.DirectorySeparatorChar);
